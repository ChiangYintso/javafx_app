...
public class AccountServiceImpl implements AccountService {
	...
	public CustomInfo register(String username, String password) {
		return new CustomInfo((short) 200, "注册成功", new User(123, "Cindy", "Hello JavaFX", new ArrayList<>()));
	}

	@Override
	public CustomInfo login(String username, String password) {
		return new CustomInfo((short) 200, "登录成功", new User(123, "Cindy", "Hello JavaFX", new ArrayList<>()));
	}
