...
public class LoginController {
    ...
    void login(ActionEvent event) throws IOException {
        ...
        if (userIdStr.getText().isBlank() || title.getText().isBlank()) {
            ...
            if (user == null) {
                ...
                SceneRouter.showStage("Õ¯¬Á¡ƒÃÏ “", "MainBoard.fxml", "client");
            }
        }
    }
    ...
    void register(ActionEvent event) throws IOException {
        SceneRouter.showStage("◊¢≤·", "Register.fxml", "client");
    }

    @FXML
    void retrievePassword(ActionEvent event) {
        SceneRouter.showTempStage("’“ªÿ√‹¬Î", "RetrievePassword.fxml", "client");
    }
}
